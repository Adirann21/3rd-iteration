<?php $__env->startSection('title', 'Reserve - Campus Reserve'); ?>
...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <a href="<?php echo e(route('credentials.index')); ?>" class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900"><?php echo e(Auth::user()->savedCredentials->count()); ?></p>
                    </div>
                </div>
            </a>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                    ...
                    <div class="p-4">
                        ...
                        <button class="mt-3 w-full py-2 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors text-sm">
                            Reserve Now
                        </button>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\campus-reserve\resources\views/reserve.blade.php ENDPATH**/ ?>